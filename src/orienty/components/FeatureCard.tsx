  ...
  return (
    <div className="flex flex-col flex-1 shrink basis-0 min-w-[200px] max-md:max-w-full">
      <div className="flex gap-2.5 items-start pl-8 max-w-full w-[104px] max-md:pl-5">
        <div className="flex gap-2.5 items-center p-2 bg-sky-900 rounded-xl border-2 border-solid border-neutral-800 h-[50px] w-[50px]">
          <img
            loading="lazy"
            src={icon}
            alt={`${title} icon`}
      ...
      <div className="flex overflow-hidden flex-col px-5 pt-8 pb-12 w-full bg-white rounded-xl border-2 border-solid shadow-sm border-neutral-800 max-md:px-5 max-md:max-w-full">
